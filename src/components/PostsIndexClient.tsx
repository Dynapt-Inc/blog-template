...
import type { PostData, SiteData } from "@/lib/content";
...
export function PostsIndexClient({ site, posts }: PostsIndexClientProps) {
        ...
        <div className="mx-auto max-w-7xl px-4 sm:px-6 lg:px-8">
          <div className="text-center">
            ...
            <p className="body-large text-muted-foreground max-w-2xl mx-auto mb-8">
              ...
              stories. Find exactly what you&apos;re looking for with our search
              and filtering tools.
            </p>
